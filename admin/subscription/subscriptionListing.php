                            ...
                            <td>
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu text-left custom-dropdown">
                                  <a class="dropdown-item" href="subscriptionDetails.php">
                                    <i class="far fa-eye "></i>Details</a>
                                  <button type="button" class="dropdown-item notBtn" data-bs-toggle="modal" data-bs-target="#Activateplane"><i class="fas fa-times"></i>Mark as active</button>
                                  <a class="dropdown-item" href="#">
                                    <i class="fas fa-pen"></i>Edit</a>
                                </div>
                              </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center p-0 mt-3">
        ...
        <div class="text-center mt-4">
          <button type="button" data-bs-toggle="modal" data-bs-target="#planInActivateUpdate" data-bs-dismiss="modal" class="main-modalbtn-light me-md-3 mb-2">Yes</button>
...
<div class="modal fade" id="planInActivateUpdate" tabindex="-1" aria-labelledby="PlanLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <button type="button" class="btn-close customclose" data-bs-dismiss="modal" aria-label="Close"></button>
      <div class="modal-header-content">
...
<!-- Active Plan Modal -->
<div class="modal fade" id="Activateplane" tabindex="-1" aria-labelledby="ActivateplaneLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <button type="button" class="btn-close customclose" data-bs-dismiss="modal" aria-label="Close"></button>
      <div class="modal-header-content">
      ...
      <div class="modal-body text-center p-0 mt-3">
        ...
        <div class="text-center mt-4">
          <button type="button" data-bs-toggle="modal" data-bs-target="#planeActivated" data-bs-dismiss="modal" class="main-modalbtn-light me-md-3 mb-2">Yes</button>
          <button type="button" data-bs-dismiss="modal" data-bs-dismiss="modal" class="main-modalbtn mb-2">No</button>
        </div>
      </div>
    </div>
...
<!-- Active Plan Updated Modal -->
<div class="modal fade" id="planeActivated" tabindex="-1" aria-labelledby="userLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <button type="button" class="btn-close customclose" data-bs-dismiss="modal" aria-label="Close"></button>
      <div class="modal-header-content">
