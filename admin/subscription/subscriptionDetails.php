        ...
        <div class="box">
          ...
          <div class="row">
            <div class="col-xl-8 col-lg-10">
              ...
              <!-- Plans Start-->
              <div class="plans my-5">
                <h5 class="site-text">Meal Plan 1 <span class="textDanger site-text ms-5">$19</span></h5>
          ...
          <div class="text-lg-start text-center">
            ...
            <button class="main-primarybtns my-2">Edit</button>
          </div>
        </div>
