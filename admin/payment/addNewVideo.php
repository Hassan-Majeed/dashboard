    ...
    <div class="content-body">
      ...
      <section id="configuration">
        ...
        <div class="d-flex align-items-center my-3">
          ...
          <h1 class="section-heading font-commons my-2">Add New Video</h1>
        </div>
        <div class="box">
          <div class="row">
            <div class="col-xl-5 col-lg-8 col-md-10">
              <form action="#">
                <div class="label-wrap mb-3">
                  ...
                  <input id="videoTitle" type="text" class="profileInp" placeholder="Enter Title" value="">
                </div>
                <div class="label-wrap mb-3">
                  <label for="description" class="d-block mb-2 ms-md-4">Description<span class="text-danger">*</span> </label>
                  <input id="description" type="text" class="profileInp" placeholder="Enter Description" value="">
                </div>
                <div class="label-wrap mb-3">
                ...
                <button class="main-primarybtns my-2" type="button" data-bs-toggle="modal" data-bs-target="#videoAdded">Add</button>
              </form>
            </div>
          </div>
        </div>
...
<!-- Video Added  Modal -->
<div class="modal fade" id="videoAdded" tabindex="-1" aria-labelledby="userLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body text-center p-0 mt-3">
        <h6 class="modal-text">Video Added Successfully!</h6>
      </div>
    </div>
  </div>
</div>