    ...
    <div class="content-body">
      ...
      <section id="configuration">
        ...
        <div class="d-flex align-items-center my-3">
          ...
          <h6 class="section-heading font-commons mb-0">Add User</h6>
        </div>
        <div class="box">
          <form action="#">
            <div class="row p-2">
              <div class="col-xl-8 col-lg-10">
                ...
                <button type="button" data-bs-toggle="modal" data-bs-target="#userAdded" class="main-primarybtns my-4">Add User</button>
              </div>
            </div>
          </form>
        </div>
...
<!-- User Added  Modal -->
<div class="modal fade" id="userAdded" tabindex="-1" aria-labelledby="userLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body text-center p-0 mt-3">
        <h6 class="modal-text">User Added Successfully!</h6>
      </div>
    </div>
  </div>
</div>