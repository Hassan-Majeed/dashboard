      ...
      <section id="configuration">
        ...
        <div class="box">
          <form action="#">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-7">
                    <div class="label-wrap mb-4">
                      <label for="title" class="d-block ms-md-3">Program Title<span class="text-danger">*</span> </label>
                      <input type="text" id="title" class="profileInp" placeholder="Enter Title">
                    </div>
                  </div>
                  <div class="col-lg-6  col-md-7">
                    <div class="label-wrap mb-4">
                      <label for="prices" class="d-block ms-md-3">Prices Per Hour<span class="text-danger">*</span> </label>
                      <input type="text" id="prices" class="profileInp" placeholder="Enter Prices">
                    </div>
                  </div>
                  <div class="col-lg-6  col-md-7">
                    <div class="label-wrap mb-4">
                      <div class="d-flex align-items-end">
                        <div class="w-100">
                          <label for="prices" class="d-block ms-md-3">Upload Image<span class="text-danger">*</span> </label>
                          <div class="profileInp d-flex  alignment-xy-bw">
                            <span class="file-name">Upload Image</span>
                            <button type="button" class="text-danger notBtn" onclick="document.getElementById('uploadFile').click()">Upload</button>
                  ...
                  <div class="col-lg-6  col-md-7">
                    <div class="label-wrap mb-4">
                      <label for="description" class="d-block ms-md-3">Description<span class="text-danger">*</span> </label>
            ...
            <button class="main-primarybtns my-2 mx-md-3" type="button" data-bs-toggle="modal" data-bs-target="#programAdded">Add</button>
...
<div class="modal fade" id="programAdded" tabindex="-1" aria-labelledby="programAddedLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body text-center p-0 mt-3">
        <h6 class="modal-text">Program Added Successfully!</h6>
      </div>
    </div>
  </div>
</div>