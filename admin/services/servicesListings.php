  ...
  <div class="content-wrapper">
    <div class="content-body">
      ...
      <section id="configuration">
        <!-- Services/Plans Starts -->
        <div class="d-md-flex alignment-xy-bw text-center">
          <h1 class="section-heading font-commons my-2 mb-4">Services/Plans</h1>
          <a href="../services/addProgram.php" class="main-primarybtns my-2 mb-4">Add New</a>
        </div>
        <div class="box">
                            ...
                            <td>
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu text-left custom-dropdown">
                                  <a class="dropdown-item" href="programDetails.php">
                                    <i class="far fa-eye "></i>Details</a>
                                  <button type="button" class="dropdown-item notBtn" data-bs-toggle="modal" data-bs-target="#inActivateprogram"><i class="fas fa-times"></i>Mark as Inactive</button>
                                  <a class="dropdown-item" href="editProgram.php">
                            ...
                            <td>
                              <div class="btn-group">
                                ...
                                <div class="dropdown-menu text-left custom-dropdown">
                                  <a class="dropdown-item" href="programDetails.php">
                                    <i class="far fa-eye "></i>Details</a>
                                  <button type="button" class="dropdown-item notBtn" data-bs-toggle="modal" data-bs-target="#activateServices"><i class="fas fa-check"></i>Mark as active</button>
                                  <a class="dropdown-item" href="editProgram.php">
                                    <i class="fas fa-pen"></i>Edit</a>
                                </div>
                              </div>
...
<!-- Inactive Program Modal -->
<div class="modal fade" id="inActivateprogram" tabindex="-1" aria-labelledby="inActivateprogramLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body text-center p-0 mt-3">
        <h6 class="modal-text mt-2">Are You Sure You Want <br> To Inactive This Program?</h6>
        <div class="text-center mt-4">
          <button type="button" data-bs-toggle="modal" data-bs-target="#programInactivated" data-bs-dismiss="modal" class="main-modalbtn-light me-md-3 mb-2">Yes</button>
...
<!-- Inactive Successfully  Program Modal -->
<div class="modal fade" id="programInactivated" tabindex="-1" aria-labelledby="userLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <button type="button" class="btn-close customclose" data-bs-dismiss="modal" aria-label="Close"></button>
      <div class="modal-header-content">
      ...
      <div class="modal-body text-center p-0 mt-3">
        <h6 class="modal-text">Program Marked As Inactive <br>
          Successfully!</h6>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="activateServices" tabindex="-1" aria-labelledby="activateServicesLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <button type="button" class="btn-close customclose" data-bs-dismiss="modal" aria-label="Close"></button>
      <div class="modal-header-content">
      ...
      <div class="modal-body text-center p-0 mt-3">
        <h6 class="modal-text mt-2">Are You Sure You Want <br> Active This Program?</h6>
        <div class="text-center mt-4">
          <button type="button" data-bs-toggle="modal" data-bs-target="#sctivatedServicesUpdate" data-bs-dismiss="modal" class="main-modalbtn-light me-md-3 mb-2">Yes</button>
          <button type="button" data-bs-dismiss="modal" data-bs-dismiss="modal" class="main-modalbtn mb-2">No</button>
        </div>
      </div>
    </div>
...
<!-- Service Activated Updated Modal -->
<div class="modal fade" id="sctivatedServicesUpdate" tabindex="-1" aria-labelledby="userLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <button type="button" class="btn-close customclose" data-bs-dismiss="modal" aria-label="Close"></button>
      <div class="modal-header-content">
      ...
      <div class="modal-body text-center p-0 mt-3">
        <h6 class="modal-text">Service Activated Successfully</h6>
      </div>
    </div>
  </div>
</div>