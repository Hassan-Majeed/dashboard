    ...
    <div class="content-body">
      ...
      <section id="configuration">
        ...
        <div class="d-flex align-items-center my-3">
          ...
          <h6 class="section-heading font-commons mb-0">Add New Subscription Plan</h6>
        </div>
        <div class="box">
          <!-- Plans Start-->
          <div class="row mt-5">
          ...
          <div class="row mt-3">
            <div class="col-xxl-10">
              <h5 class="site-text mb-4">Meal Plan Details</h5>
              <!-- Tabs start -->
              <div id="daysTab">
          ...
          <div class="text-lg-start text-center">
            <button type="button" data-bs-toggle="modal" data-bs-target="#planUpdated" class=" main-primarybtns my-2">Add</button>
          </div>
        </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body text-center p-0 mt-3">
        <h6 class="modal-text">Plan Added Successfully!</h6>
      </div>
    </div>
  </div>
</div>